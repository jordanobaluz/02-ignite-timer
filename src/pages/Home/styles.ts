...
export const HomeContainer = styled.main`
  ...
  /*fará o alinhamento dos elementos para centralizar*/
  form {
    display: flex;
    flex-direction: column;
    align-items: center;
...
export const CountdownContainer = styled.div`
  ...
  font-size: 10rem;
  line-height: 8rem; /*especifica a distancia entre a linha do texto e o bloco do elemento */
  color: ${(props) => props.theme['gray-100']};
...
export const Separator = styled.div`
  ...
  width: 4rem;
  overflow: hidden; /*impede de exibir uma barra de rolagem */
  display: flex;
  justify-content: center;
`
